  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <div style={{ fontSize: "64px", fontWeight: "bold", marginBottom: "20px", maxWidth: "900px" }}>{title}</div>
          <div style={{ fontSize: "32px", opacity: 0.9, maxWidth: "800px" }}>{siteName.toString()}</div>
